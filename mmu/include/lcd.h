...
#define W1KEYCON1 		0x11c00144

extern void lcd_init(void);
extern void draw_point(int, int ,int, int);

#define MAKE_COL(r,g,b) ((r << 16) | (g << 8) | (b))

/*window0的frambuf0对应的内存起始地址*/
#define WIN0FRAMBUF0 0x52000000
#define WIN1FRAMBUF0 0x60000000
